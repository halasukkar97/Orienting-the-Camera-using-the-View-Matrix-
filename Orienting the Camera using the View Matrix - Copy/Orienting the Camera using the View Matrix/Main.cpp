...
HRESULT InitialiseGraphics()//03-01
{
	...
	POS_COL_VERTEX vertices[] =
	{
		...
		{ XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
		// right face
		{XMFLOAT3(1.0f, -1.0f, 1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f) },
		{XMFLOAT3(1.0f, -1.0f, -1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f) },
		{XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(1.0f, 0.70f, 0.40f, 1.0f) },
		...
		// bottom face
		{XMFLOAT3(1.0f, -1.0f, -1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f) },
		{XMFLOAT3(1.0f, -1.0f, 1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f) },
		{XMFLOAT3(-1.0f, -1.0f, -1.0f),XMFLOAT4(0.20f, 0.30f, 0.40f, 1.0f) },
		...
		// top face
		{XMFLOAT3(1.0f, 1.0f, 1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f) },
		{XMFLOAT3(1.0f, 1.0f, -1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f) },
		{XMFLOAT3(-1.0f, 1.0f, -1.0f),XMFLOAT4(-1.0f, -1.0f,0.30f, 1.0f) },
...
void RenderFrame(void)
{
	...
	world *= XMMatrixTranslation(1, 1, 15);    // the place of the triangles
	projection = XMMatrixPerspectiveFovLH(XMConvertToRadians(45.0), 640.0 / 480.0, 1.0, 100.);
	...
	world_second_cube = XMMatrixTranslation(0, 0, 12);    // the place of the triangles
